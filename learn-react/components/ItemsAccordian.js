...
const ItemsAccrodian = function (props) {
  ...
  return (
    <div className=" h-full  mt-20 w-full flex flex-col justify-center items-center border-r-amber-600 rounded-b-xl">
      <div className="flex justify-between w-10/12 bg-gray-300 content-between rounded-lg">
